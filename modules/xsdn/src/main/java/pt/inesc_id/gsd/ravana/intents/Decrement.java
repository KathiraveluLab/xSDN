...
/**
 * Where the user intent is to decrease something.
 */
public abstract class Decrement implements Intent {
    private int priority = 1;
    private int intent = RavanaConstants.IntentQuotient.MINIMIZE;
